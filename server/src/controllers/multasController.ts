...
// Nota (A7): el alta de multas por impago la realiza el sistema automaticamente
// (socket confirm-payment) o la empresa via POST /api/admin/multas (rol admin).
// Se removio el POST /multas publico que permitia a cualquier usuario autenticado
// crear multas.
